...
<Note>
  You can verify the workplace you're currently working at. At the moment, verification for past workplaces isn't available.
</Note>
...
* **Verification cost:** Workplace and bootcamp verification is free. Identity verification has a minimal fee associate with it.

* **Verifications are visible, but you can remove them anytime.** A verification indicating that your identity, workplace, or bootcamp is confirmed will be visible on your profile when you complete the verification process. The information used for verification (i.e. the work email address or information on your ID card) will not be visible. You can remove verifications anytime from Manage Verification settings. Learn more about our practices in our <a href={APP_PATHS.privacyPolicy}>Privacy Policy</a>.
