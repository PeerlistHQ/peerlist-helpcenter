...
<AccordionGroup>
  ...
  <Accordion title="Why my profile got suspended?">
    ...
    * Violation of <a href={APP_PATHS.termConditions} target='_blank' rel='noopener noreferrer'>{APP_PATHS.termConditions}</a>.
  </Accordion>
  ...
  <Accordion title="How to verify Peerlist profile?">
    You can verify your Peerlist profile by verifying identity, present workplace, education, or bootcamp. You can find more details about <a href={APP_PATHS.verification} target='_blank' rel='noopener noreferrer'>{APP_PATHS.verification}</a>.
  </Accordion>
</AccordionGroup>
