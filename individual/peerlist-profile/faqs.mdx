...
<AccordionGroup>
  ...
  <Accordion title="How to verify Peerlist profile?">
    You can verify your Peerlist profile by verifying your Identity, present workplace, or bootcamp. You can find more details about <a href={APP_PATHS.verification}>Peerlist Verification</a>.
  </Accordion>
</AccordionGroup>
